...
df_ambi_ranges_ls2_vs_ns3_smad2 <- ambi_ranges_ls2_vs_ns3$Smad2 %>% as.data.frame() %>% as_tibble() ## data frame created from ambiguous gene ranges
...
df_ambi_ranges_ls2_vs_ns3_smad3 <- ambi_ranges_ls2_vs_ns3$Smad3 %>% as.data.frame() %>% as_tibble() ## data frame created from ambiguous gene ranges
